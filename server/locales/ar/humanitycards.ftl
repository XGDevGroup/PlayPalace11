...
hc-card-fallback = البطاقة { $index }
...
hc-judge-prompt-header = اختر أفضل بطاقة تناسب: { $prompt }
hc-judge-prompt-header-empty = اختر أفضل بطاقة.

# Results
hc-submission-fallback = الإجابة { $index }
