...
hc-judge-prompt-header = Choisissez la meilleure carte pour : { $prompt }
hc-judge-prompt-header-empty = Choisissez la meilleure carte.

# Results
hc-submission-fallback = Soumission { $index }
