...
hc-judge-prompt-header = Válaszd ki a legjobb lapot ehhez: { $prompt }
hc-judge-prompt-header-empty = Válaszd ki a legjobb lapot.

# Results
hc-submission-fallback = Beküldés { $index }
