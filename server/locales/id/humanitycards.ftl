...
hc-judge-prompt-header = Pilih kartu terbaik yang cocok dengan: { $prompt }
hc-judge-prompt-header-empty = Pilih kartu terbaik.

# Results
hc-submission-fallback = Kiriman { $index }
