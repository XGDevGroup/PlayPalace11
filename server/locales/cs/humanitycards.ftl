...
hc-judge-prompt-header = Vyberte nejlepší kartu, která se hodí k: { $prompt }
hc-judge-prompt-header-empty = Vyberte nejlepší kartu.

# Results
hc-submission-fallback = Odpověď { $index }
