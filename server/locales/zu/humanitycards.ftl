...
hc-judge-prompt-header = Khetha ikhadi elihambisana kahle nalokhu: { $prompt }
hc-judge-prompt-header-empty = Khetha ikhadi elihle kakhulu.

# Results
hc-submission-fallback = Impendulo { $index }
