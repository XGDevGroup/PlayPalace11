...
hc-judge-prompt-header = Wybierz najlepszą kartę pasującą do: { $prompt }
hc-judge-prompt-header-empty = Wybierz najlepszą kartę.

# Results
hc-submission-fallback = Zgłoszenie { $index }
