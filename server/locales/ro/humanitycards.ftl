...
hc-judge-prompt-header = Alege cea mai bună carte care se potrivește cu: { $prompt }
hc-judge-prompt-header-empty = Alege cea mai bună carte.

# Results
hc-submission-fallback = Propunere { $index }
