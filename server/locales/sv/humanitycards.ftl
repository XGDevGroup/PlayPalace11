...
hc-judge-prompt-header = Välj det bästa kortet som passar: { $prompt }
hc-judge-prompt-header-empty = Välj det bästa kortet.

# Results
hc-submission-fallback = Bidrag { $index }
