...
hc-judge-prompt-header = เลือกไพ่ที่เข้ากับข้อความนี้ที่สุด: { $prompt }
hc-judge-prompt-header-empty = เลือกไพ่ที่ดีที่สุด

# Results
hc-submission-fallback = คำตอบ { $index }
