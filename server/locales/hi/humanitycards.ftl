...
hc-judge-prompt-header = इससे मेल खाने वाला सबसे अच्छा कार्ड चुनें: { $prompt }
hc-judge-prompt-header-empty = सबसे अच्छा कार्ड चुनें।

# Results
hc-submission-fallback = जवाब { $index }
