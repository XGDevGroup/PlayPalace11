...
hc-judge-prompt-header = Izberite najboljšo karto, ki ustreza: { $prompt }
hc-judge-prompt-header-empty = Izberite najboljšo karto.

# Results
hc-submission-fallback = Oddaja { $index }
