...
hc-judge-prompt-header = Escolha a melhor carta que combina com: { $prompt }
hc-judge-prompt-header-empty = Escolha a melhor carta.

# Results
hc-submission-fallback = Resposta { $index }
