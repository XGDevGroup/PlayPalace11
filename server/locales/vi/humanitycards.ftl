...
hc-judge-prompt-header = Chọn lá bài phù hợp nhất với: { $prompt }
hc-judge-prompt-header-empty = Chọn lá bài hay nhất.

# Results
hc-submission-fallback = Bài nộp { $index }
