...
hc-judge-prompt-header = Scegli la carta migliore che corrisponde a: { $prompt }
hc-judge-prompt-header-empty = Scegli la carta migliore.

# Results
hc-submission-fallback = Risposta { $index }
