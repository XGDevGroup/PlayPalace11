...
hc-judge-prompt-header = Elige la mejor carta que encaje con: { $prompt }
hc-judge-prompt-header-empty = Elige la mejor carta.

# Results
hc-submission-fallback = Respuesta { $index }
