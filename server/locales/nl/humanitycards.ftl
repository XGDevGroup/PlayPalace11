...
hc-judge-prompt-header = Kies de beste kaart die past bij: { $prompt }
hc-judge-prompt-header-empty = Kies de beste kaart.

# Results
hc-submission-fallback = Inzending { $index }
