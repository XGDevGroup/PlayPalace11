...
hc-judge-prompt-header = Odaberite najbolju kartu koja odgovara: { $prompt }
hc-judge-prompt-header-empty = Odaberite najbolju kartu.

# Results
hc-submission-fallback = Predaja { $index }
