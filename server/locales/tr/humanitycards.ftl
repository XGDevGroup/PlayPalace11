...
hc-judge-prompt-header = Şuna en uygun kartı seçin: { $prompt }
hc-judge-prompt-header-empty = En iyi kartı seçin.

# Results
hc-submission-fallback = Cevap { $index }
