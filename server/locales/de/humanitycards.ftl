...
hc-judge-prompt-header = Wähle die beste Karte zu: { $prompt }
hc-judge-prompt-header-empty = Wähle die beste Karte.

# Results
hc-submission-fallback = Einreichung { $index }
