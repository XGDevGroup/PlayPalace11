...
hc-judge-prompt-header = بهترین کارت را برای این متن انتخاب کنید: { $prompt }
hc-judge-prompt-header-empty = بهترین کارت را انتخاب کنید.

# Results
hc-submission-fallback = پاسخ { $index }
