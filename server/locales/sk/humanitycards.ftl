...
hc-judge-prompt-header = Vyberte najlepšiu kartu, ktorá sa hodí k: { $prompt }
hc-judge-prompt-header-empty = Vyberte najlepšiu kartu.

# Results
hc-submission-fallback = Odpoveď { $index }
