...
hc-judge-prompt-header = Виберіть найкращу карту для: { $prompt }
hc-judge-prompt-header-empty = Виберіть найкращу карту.

# Results
hc-submission-fallback = Відповідь { $index }
